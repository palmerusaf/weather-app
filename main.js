...
async function handleSubmit(event) {
  try {
    ...
    (0,_modules_status_messages__WEBPACK_IMPORTED_MODULE_0__.displayStatus)("Gathering Weather Info");
    const rawData = await (0,_modules_api_fetch__WEBPACK_IMPORTED_MODULE_1__.getCurrentForecastFromWeatherServer)(value);
    (0,_modules_status_messages__WEBPACK_IMPORTED_MODULE_0__.displayStatus)("Displaying Weather Info");
